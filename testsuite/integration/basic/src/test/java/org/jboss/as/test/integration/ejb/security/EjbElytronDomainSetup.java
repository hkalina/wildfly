 ...
 */
public class EjbElytronDomainSetup implements ServerSetupTask /*extends AbstractSecurityDomainSetup*/ {
    ...
    public void setup(final ManagementClient managementClient, final String containerId) throws Exception {
        ...
        addRealm.get("users-properties").get("path").set("/home/jkalina/wildfly/wildfly/testsuite/integration/basic/src/test/java/org/jboss/as/test/integration/ejb/security/users.properties");
        addRealm.get("groups-properties").get("path").set("/home/jkalina/wildfly/wildfly/testsuite/integration/basic/src/test/java/org/jboss/as/test/integration/ejb/security/roles.properties");
